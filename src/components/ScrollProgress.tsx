...
const ScrollProgress = () => {
  ...
  const sections = ['Hero', 'About', 'Skills', 'AI Tools', 'Code Editor', 'Skill Bars', 'Full Stack', 'Projects', 'Production', 'Terminal', 'Simulation', 'Architecture', 'Experience', 'Aspirations', 'Security', 'Contact']
        ...
        {sections.map((section, i) => (
          <button
            ...
            className={`pointer-events-auto w-2 h-2 rounded-full transition-all ${
              activeSection === i ? 'bg-primary w-3 shadow-[0_0_10px_rgba(99,102,241,0.5)]' : 'bg-surface2 hover:bg-primary/50'
            }`}

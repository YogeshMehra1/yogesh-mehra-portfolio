      ...
      <div className="container mx-auto">
        ...
        >
          <div className="flex items-center justify-center gap-4">
            ...
            />
            <span className="text-2xl font-bold gradient-text">99.5%</span>
        ...
        >
          <div className="glass rounded-xl p-6 card-hover">
            <p className="text-sm text-text-secondary mb-2">Certification</p>
            <p className="mt-1 font-semibold text-primary">Oracle Agentic AI Certified Foundations Associate</p>
            <p className="mt-1 text-sm text-text-muted">September 2026</p>
          </div>
          <div className="glass rounded-xl p-6 card-hover">
